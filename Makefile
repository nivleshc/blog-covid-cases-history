...
# AWS_PROFILE_NAME
# AWS_S3_BUCKET_NAME
# AWS_S3_WEBSITE_BUCKET_NAME
# SLACK_WEBHOOK_URL

#define variables
aws_profile = ${AWS_PROFILE_NAME}
aws_s3_bucket = ${AWS_S3_BUCKET_NAME}
aws_stack_name = blog-covid-cases-history
...
usage:
	...
	@echo AWS_S3_WEBSITE_BUCKET_NAME [found:${AWS_S3_WEBSITE_BUCKET_NAME}]
...
deploy:
	...
	ParameterKey=WebsiteS3Bucket,ParameterValue=${AWS_S3_WEBSITE_BUCKET_NAME} \
